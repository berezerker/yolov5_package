...
def test_image_regression():
    ...
    original_result = cv2.imread("tests/original_image_result.jpg", cv2.IMREAD_GRAYSCALE)
    duplicate_result = cv2.imread("tests/image_testyolov5_output.jpg", cv2.IMREAD_GRAYSCALE)
